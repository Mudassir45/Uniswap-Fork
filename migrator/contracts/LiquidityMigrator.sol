...
contract LiquidityMigrator {
    ...
    function migrate() external {
        require(msg.sender == admin, "Sorry! Only Admin is allowed to Migrate.");
        require(migrationDone == false, "Migration already done.");
    ...
    function claimLpTokens() external {
        require(unclaimedBalances[msg.sender] >= 0, "Sorry! You have no Unclaimed Balance");
        require(migrationDone == true, "Sorry! Migration not done yet.");
